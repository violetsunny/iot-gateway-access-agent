...
public final class SnmpPluginSession {

    private static final long serialVersionUID = -4744070264035857273L;
    // slf4j  log
    private org.slf4j.Logger log = LoggerFactory.getLogger(SnmpPluginSession.class);
 ...
 /*       if (tableUtils == null) {
    ...
    public List<String[]> execute(final List<String> oidValues) throws Exception {
     ...
     /*    VariableBinding[] variableArr = null;
       ...
       try {
            eventList = tableUtils.getTable(target, snmpoids, null, null);
            if (log.isDebugEnabled()) {
